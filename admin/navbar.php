      ...
      <li><a href="/iaw/tienda2020/admin/catalogo/catalogo_articulos.php">NUESTRO CATÁLOGO</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            if (isset($_SESSION['nombre'])) {
                ...
                echo "<li><a href='/iaw//tienda/vistas/usuario.php?id=". encode($_SESSION['id_usuario'])."&email=".encode($_SESSION['email'])."'><span class='glyphicon glyphicon-user'></span> ". $_SESSION['apellidos']. " </a></li>";
