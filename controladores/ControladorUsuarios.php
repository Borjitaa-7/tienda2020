...
class ControladorUsuarios {
    ...
    public function actualizarUsuario($id, $dni, $nombre, $apellidos, $email, $password, $admin, $telefono, $fecha, $imagen){
     ...
     public function actualizarUsuario2($id, $dni, $nombre, $apellidos, $email, $password, $telefono, $imagen){
        $bd = ControladorBD::getControlador();
        $bd->abrirBD();
        $consulta = "UPDATE usuarios SET dni=:dni, nombre=:nombre, apellidos=:apellidos, email=:email, password=:password,
